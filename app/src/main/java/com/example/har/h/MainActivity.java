...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSensorManager = (SensorManager) getSystemService(Context.SENSOR_SERVICE); //initializing sensor service,permission to use the sensor
    ...
    @Override
    public void onSensorChanged(SensorEvent event) {  //getting event i.e values of x, y and z axiz
        activityPrediction();
    ...
    public void startAR(View view) {
        mSensorManager.registerListener(this, mAccelerometer, SensorManager.SENSOR_DELAY_FASTEST); //Registerd accelorometer listner
        confidenceView = false;
    }
